...
import { deleteDemoUser } from '@/lib/okrAllyDemo'
 ...
 * admin view. Best-effort deletes the demo account that was in use.
 */
export async function POST(req: NextRequest) {
  ...
  if (user?.is_demo) {
    deleteDemoUser(user.id).catch((e) => console.error('demo exit: cleanup failed', e))
  }
