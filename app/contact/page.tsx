...
const FAQS = [
  {
    q: 'What is the best way to start working with you?',
    a: 'The best starting point is a 30 minute discovery call. It gives us both a chance to understand whether there is a good fit before committing to anything. You can book directly using the calendar link above.',
  },
  {
    q: 'Do you work with clients outside India?',
    a: 'Yes. While I am based in Chennai I work with clients across India and internationally via video conferencing. In-person engagements outside Chennai are possible with travel arrangements covered by the client.',
  },
  {
    q: 'How long does a typical coaching or consulting engagement last?',
    a: 'Executive coaching typically runs for one quarter to six months. OKR consulting and strategy engagements vary based on scope — a focused OKR design sprint can be completed in four to six weeks while a full strategy engagement runs quarterly. We discuss and agree on scope before any engagement begins.',
  },
  {
    q: 'Do you offer group or team programmes?',
    a: 'Yes. In addition to one to one coaching I offer group coaching programmes, leadership team workshops, and Academy modules designed for teams. Reach out to discuss what would work best for your situation.',
  },
]

// ── Reusable styled input helper ────────────────────────────
...
export default function ContactPage() {
  ...
  // ── Focus helpers (inline border swap) ──────────────────
          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-8 lg:gap-10 items-start">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Field label="Your message">
                    <textarea
                      rows={5}
                      placeholder="Tell me about your situation, what you are looking to achieve, or any questions you have…"
                      value={message}
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full py-4 text-white text-sm font-semibold rounded-lg transition-colors"
            ...
            <div className="space-y-6">
              ...
              <div
                ...
                style={{ backgroundColor: '#2C2C2A', borderColor: '#2C2C2A' }}
              >
                <h3 className="font-lora text-lg font-bold text-white mb-2">
              ...
              <div className="rounded-2xl border p-7 bg-white" style={{ borderColor: '#E8E4DC' }}>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    ...
                    <a
                      href="mailto:pgs@embiggen.co.in"
                      className="text-sm font-medium text-[#2C2C2A] hover:text-[#633806] transition-colors"
                    >
                      pgs@embiggen.co.in
                    </a>
                  </li>
              ...
              <div className="rounded-2xl border p-7 bg-white" style={{ borderColor: '#E8E4DC' }}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-1 leading-relaxed" style={{ color: '#888780' }}>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <svg viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3" style={{ color: isOpen ? '#ffffff' : '#633806' }}>
      ...
      <section className="py-14 lg:py-20" style={{ backgroundColor: '#2C2C2A' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a
              href="/assessment"
              className="inline-flex items-center gap-2 px-8 py-4 border-2 border-white/30 text-white font-medium rounded-lg hover:border-white transition-colors"
            >
              Take the assessment
              <ArrowIcon />
            </a>
